...
public class LivestreamCommand implements CommandExecutor {
    ...
    public LivestreamCommand(ChatLockManager chatLockManager) {
    ...
    public boolean onCommand(
        ...
        if (args.length == 0) {
            player.sendMessage(Component.text("Usage: /livestream [url]")
                    .color(TextColor.color(0xFF5555)));
            return true;
        }
        ...
        // Title
        Component title = Component.text(player.getName().toUpperCase() + " IS STREAMING")
                .color(pink)
        ...
        Component link = Component.text(displayUrl)
                ...
                .hoverEvent(HoverEvent.showText(Component.text("Click to open stream")));
